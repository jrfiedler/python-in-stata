...
\title{The Python plugin for Stata, version 1.0.0}
...
\begin{itemize}
\item \lstinline{st_Matrix} and \lstinline{st_View} (note the capital \lstinline{M} and \lstinline{V}) have been replaced with \lstinline{st_matrix} and \lstinline{st_view} (lowercase \lstinline{m} and \lstinline{v}).
...
\section{Using Python files} \label{using_files}
